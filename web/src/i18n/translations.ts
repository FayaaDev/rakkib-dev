...
export const translations = {
  ...
  ar: {
    metaTitle: 'ركّب: ضبط سيرفرك بدون اشتراكات',
    metaDescription: 'ركّب يثبت لك حزمة أدوات بإختيارك بأمر واحد.',
    brandLabel: 'الصفحة الرئيسية لركّب',
    heroEyebrow: 'من جهاز جديد إلى سحابة منزلية',
    heroTitle: 'أدواتك الخاصة، بدون اشتراكات',
    heroText:
      'ركّب يضبط جهازك القديم او سيرفرك المنزلي. أختار من حزمة تشمل تطبيقات الذكاءالاصطناعي والأتمتة والتصميم والتخزين وغيرها.',
    heroPrimaryAction: 'استعرض الادوات',
    copy: 'نسخ',
    copied: 'تم النسخ!',
    installNote:
      'انسخ هذا الأمر والصقة في التيرمنال. وركّب بشيل عنك الباقي.',
    sectionLabel: 'الادوات ',
    servicesTitle: 'أختر الادوات اللي تناسبك',
    catalogIntro: 'ابحث في القائمة عن الادوات اللي تبيها، تواصل معنا لو ودك نضيف اداة ماحصلتها.',
    categoriesLabel: 'التصنيفات ',
    optional: 'اختياري',
    github: 'GitHub',

    serviceLibraryLabel: ' الادوات',
    serviceSearchTitle: 'ابحث حسب الاداة أو التصنيف',
    serviceSearchPlaceholder: 'ابحث',
    serviceSearchAriaLabel: 'بحث في الادوات',
    ...
    services: {
      Caddy: 'خادم ويب (Reverse Proxy) لإدارة النطاقات والادوات',
      ...
      Homepage: 'لوحة لعرض جميع التطبيقات والادوات',
      'Uptime Kuma': 'مراقبة توفر الادوات والتنبيهات',
      ...
      homepage: 'لوحة الادوات (ضمن الحزمة الأساسية)',
